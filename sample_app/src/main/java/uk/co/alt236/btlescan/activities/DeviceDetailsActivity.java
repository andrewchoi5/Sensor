...
public class DeviceDetailsActivity extends AppCompatActivity  {
    ...
    private BluetoothLeDevice mDevice1;
    private BluetoothLeDevice mDevice2;
    private BluetoothLeDevice mDevice3;
    ...
    private void appendDeviceInfo(final MergeAdapter adapter, final BluetoothLeDevice device) {
        ...
        final TextView tvPersonName = (TextView) lt.findViewById(R.id.ownerName);
        final TextView tvCorporationName = (TextView) lt.findViewById(R.id.corporationName);
        final TextView tvCollaboratorName = (TextView) lt.findViewById(R.id.collaboratorName);
//        final GraphView gvGraph = (GraphView)lt.findViewById(R.id.graphSecond);
        ...
        tvPersonName.setText("Andrew Choi");
        tvCorporationName.setText("IBM Corporation");
        tvCollaboratorName.setText("Mehran M. Najafi");
    ...
    private void appendRssiInfo(final MergeAdapter adapter, final BluetoothLeDevice device) {
        ...
        final TextView tvVisualization = (TextView) lt.findViewById(R.id.visualization);


        PointsGraphSeries<DataPoint> series = new PointsGraphSeries<DataPoint>(new DataPoint[] {
                  new DataPoint(0, device.getRssi())
//                new DataPoint(0, 1),
//                new DataPoint(4, 6)
        });
        ...
        tvVisualization.setText(formatRssi(device.getRunningAverageRssi()));
...
//    }
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mDevice1 = getIntent().getParcelableExtra(EXTRA_DEVICE1);
        mDevice2 = getIntent().getParcelableExtra(EXTRA_DEVICE2);
        mDevice3 = getIntent().getParcelableExtra(EXTRA_DEVICE3);
        pupulateDetails(mDevice);
        pupulateDetails(mDevice1);
        pupulateDetails(mDevice2);
        pupulateDetails(mDevice3);
//        mBluetoothLeService.connect(mDeviceAddress);
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        intent.putExtra(DeviceControlActivity.EXTRA_DEVICE1, mDevice1);
        intent.putExtra(DeviceControlActivity.EXTRA_DEVICE2, mDevice2);
        intent.putExtra(DeviceControlActivity.EXTRA_DEVICE3, mDevice3);
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        Log.e("DeviceDetailsActivity","menu_connect details1");
        switch (item.getItemId()) {
            case R.id.menu_connect:
                Log.e("DeviceDetailsActivity", "menu_connect details2");
                final Intent intent = new Intent(this, DeviceControlActivity.class);
                intent.putExtra(DeviceControlActivity.EXTRA_DEVICE, mDevice);
                intent.putExtra(DeviceControlActivity.EXTRA_DEVICE1, mDevice1);
                intent.putExtra(DeviceControlActivity.EXTRA_DEVICE2, mDevice2);
